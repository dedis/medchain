...
// MedChainProtocol holds the state of a given protocol.
//
...
func (p *MedChainProtocol) Start() error {
	log.Lvl3(p.ServerIdentity(), "Starting MedChainProtocol")
...
// Done is called.
func (p *MedChainProtocol) Dispatch() error {
	defer p.Done()
