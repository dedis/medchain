...
function DisplayHospitalList(){
  ...
  for( var user_index in info.hospital_list){
    ...
    $('#hospital_list_table tbody').append('<tr><td><a target="_blank" href="/gui/hospital?id='+user_info.super_admin_id+'">'+user_info.hospital_name+'</td><td>'+status+'</td></tr>');
  }
...
function DisplayAdminList(){
  ...
  for( var user_index in info.hospital.admin_list){
    ...
    var status = user_info.created ? "Approved" : "Not Approved";
    $('#admin_list_table tbody').append('<tr><td><a target="_blank" href="/gui/user?id='+user_info.id+'">' +user_info.name+'</a></td><td>'+status+'</td></tr>');
  }
  $("#list_admin_div").show();
  if(info.signer.role == "super_admin"){
    AllowAddAdmin();
...
function DisplayManagerList(){
  ...
  for( var user_index in info.hospital.manager_list){
    ...
    var status = user_info.created ? "Approved" : "Not Approved";
    $('#manager_list_table tbody').append('<tr><td><a target="_blank" href="/gui/user?id='+user_info.id+'">'+user_info.name+'</a></td><td>'+status+'</td></tr>');
    if(user_info.created){
        $('#new_project_managers_table tbody').append('<tr><td><a target="_blank" href="/gui/user?id='+user_info.id+'">'+user_info.name+'</a></td><td><input type="checkbox" name="new_project_managers" value="'+user_info.id+'"></td></tr>');
    }
  }
...
function DisplayUserList(){
  ...
  for( var user_index in info.hospital.user_list){
    ...
    var status = user_info.created ? "Approved" : "Not Approved";
    $('#user_list_table tbody').append('<tr><td><a target="_blank" href="/gui/user?id='+user_info.id+'">'+user_info.name+'</a></td><td>'+status+'</td></tr>');
    if(user_info.created){
      $('#new_project_authorizations_table tbody').append('<tr><td><a target="_blank" href="/gui/user?id='+user_info.id+'">'+user_info.name+'</a></td><td><input type="checkbox" name="new_project_aggregated_users" value="'+user_info.id+'"></td><td><input type="checkbox" name="new_project_obfuscated_users" value="'+user_info.id+'"></td></tr>');
    }
  }
  $("#list_user_div").show();
  if(info.signer.role == "admin"){
...
function DisplayProjectList(){
  ...
  for( var project_index in info.project_list){
    ...
    $('#project_list_table tbody').append('<tr><td><a target="_blank" href="/gui/project?name='+project_info.name+'">'+project_info.name+'</a></td><td>'+status+'</td></tr>');
  }
